<template>
  ...
  <q-page class="page privacy">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          this Agreement) refers to Tanuki Hardware Store.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Tanuki Hardware Store, accessible
          from
    ...
    <p>
      This website only uses Cookies for login, setting the light/dark mode and
      saving the selected currency.
    </p>
    ...
    <ul>
      <li>https://github.com/HTW-KBE-G4</li>
    </ul>
  </q-page>
</template>
...
export default defineComponent({
  name: 'AboutPage',
  setup() {
    const apiLink = process.env.API ? process.env.API : 'Not available';
    const baseUrl = window.location.origin;
    return { api: apiLink, url: baseUrl };
  },
});
</script>
